...
import getObjects from '@salesforce/apex/toolingapi_DependencyAPIController.getObjects';
import getApex from '@salesforce/apex/toolingapi_DependencyAPIController.getApex';
import getLightningComponent from '@salesforce/apex/toolingapi_DependencyAPIController.getLightningComponent';
import getDepdency from '@salesforce/apex/toolingapi_DependencyAPIController.getDepdency';
...
export default class Toolingapi_DependencyExplorer extends LightningElement {
    @track objectList= [];
    @track fieldList=[];
    @track fields=[];
    @track objectFields=[];
